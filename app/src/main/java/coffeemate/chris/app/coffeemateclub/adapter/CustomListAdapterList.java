...
public class CustomListAdapterList extends BaseAdapter {
    ...
    public CustomListAdapterList(Activity activity, List<Coffee> coffeeItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView marketingtext = (TextView) convertView.findViewById(R.id.marketingtext);
        ...
        // release year
        marketingtext.setText(m.getMarketingtext());
